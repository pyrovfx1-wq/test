-- Pet Leveler Visual Script (Client-Side Only)
local Players = game:GetService("Players")
local player = Players.LocalPlayer
local TweenService = game:GetService("TweenService")

-- Fake pet data (simulate Grow a Garden pets)
local mockPetData = {
    ["Raccoon"] = {Age = "4d", Weight = "1.2kg"},
    ["Red Fox"] = {Age = "2d", Weight = "1.0kg"},
    ["Corrupted Kitsune"] = {Age = "5d", Weight = "2.5kg"},
    ["Frog"] = {Age = "1d", Weight = "0.6kg"},
    ["Penguin"] = {Age = "3d", Weight = "1.8kg"},
}
...
-- Pet Dropdown
local petSelector = Instance.new("TextButton", mainFrame)
petSelector.Position = UDim2.new(0.05, 0, 0.2, 0)
petSelector.Size = UDim2.new(0.9, 0, 0, 40)
petSelector.Text = "Select a Pet"
petSelector.BackgroundColor3 = Color3.fromRGB(30, 30, 30)
petSelector.TextColor3 = Color3.new(1, 1, 1)
petSelector.Font = Enum.Font.Gotham
petSelector.TextScaled = true

local dropdown = Instance.new("Frame", petSelector)
dropdown.Size = UDim2.new(1, 0, 0, #mockPetData * 30)
...
for petName, data in pairs(mockPetData) do
	...
	btn.MouseButton1Click:Connect(function()
		...
		petAgeLabel.Text = "Age: " .. data.Age
		petWeightLabel.Text = "Weight: " .. data.Weight
		dropdown.Visible = false
	end)
end

-- Pet Info Labels
local petNameLabel = Instance.new("TextLabel", mainFrame)
petNameLabel.Position = UDim2.new(0.05, 0, 0.4, 0)
petNameLabel.Size = UDim2.new(0.9, 0, 0, 30)
...
local petAgeLabel = petNameLabel:Clone()
petAgeLabel.Position = UDim2.new(0.05, 0, 0.5, 0)
petAgeLabel.Text = "Age: -"
petAgeLabel.Parent = mainFrame

local petWeightLabel = petNameLabel:Clone()
petWeightLabel.Position = UDim2.new(0.05, 0, 0.6, 0)
petWeightLabel.Text = "Weight: -"
petWeightLabel.Parent = mainFrame

-- Level Up Button
local levelUpBtn = Instance.new("TextButton", mainFrame)
levelUpBtn.Position = UDim2.new(0.05, 0, 0.75, 0)
levelUpBtn.Size = UDim2.new(0.9, 0, 0, 40)
levelUpBtn.Text = "Level Up (Visual Only)"
levelUpBtn.BackgroundColor3 = Color3.fromRGB(0, 170, 0)
